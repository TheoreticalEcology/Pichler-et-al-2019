...
if(run){
  ...
  ResultBaselineC$Result[["SVM"]] = ResultSizeBaselineC_SVM$Result$SVM
  ResultBaselineR$Result[["SVM"]] = ResultSizeBaselineR_SVM$Result$SVM
...
if(run){
  ...
  save(ResultSizeCagg, ResultSizeRagg,ResultObsRagg, ResultObsCagg, ResultAbCagg, ResultAbRagg, ResultBaselineCagg, ResultBaselineRagg,
       file = "./Results/ResultsSimulationAgg_GLM.RData")
}
```
...
if(run){
  ...
  saveRDS(result, file = "./Results/CaseStudy1_GLM.RDS")
