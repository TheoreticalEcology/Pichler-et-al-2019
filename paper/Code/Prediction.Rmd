...
We tested the influence of three sizes on the performance. I set the observation time $=4e3$ to get for alomost all species at least one interaction. We sampled 25 \%, 50 \% and 100 \% of the species to get three network sizes of:
