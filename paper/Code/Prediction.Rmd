...
simulatedData = simulateInteraction( main = NULL, inter = matrix(c("A1", "B1",
                              ...
                              weights = list(inter = c(4,1,1)),
                              NumberA = 100, NumberB = 200, traitsA = c(0,6), 
                              traitsB = c(0,6),abundance = 2, rangeDiscrete = 2:5)
...
```{r,results=FALSE}
interBaseP = minOneInter(simulatedData$poisson(4e3))
interBaseC = minOneInter(simulatedData$binar(4e3))
...
obsC = list(low = minOneInter(simulatedData$binar(2e2)), 
            mid = minOneInter(simulatedData$binar(1e3)), 
            high = minOneInter(simulatedData$binar(10e3)))

obsR = list(low = minOneInter(simulatedData$poisson(2e2)), 
            mid = minOneInter(simulatedData$poisson(1e3)), 
            high = minOneInter(simulatedData$poisson(10e3)))
```
...
simulatedData = simulateInteraction( main = NULL, inter = matrix(c("A1", "B1",
                              ...
                              weights = list(inter = c(4,1,1)),
                              NumberA = 100, NumberB = 200, traitsA = c(0,6), 
                              traitsB = c(0,6),abundance = FALSE, rangeDiscrete = 2:5)
interBaseP = minOneInter(simulatedData$poisson(4e3))
interBaseC = minOneInter(simulatedData$binar(4e3))
smallP = interBaseP[sample(rownames(interBaseP), 0.25*length(rownames(interBaseP))),
                    sample(colnames(interBaseP), 0.25*length(colnames(interBaseP)))]
