...
tssCI = aucCI = data.frame(matrix(0,3,9))
...
colnames(tssCI) = colnames(aucCI) = names(ResultSizeCagg[[i]])[1:len]
...
spearCI = data.frame(matrix(0,3,7))
...
save(tssCI, baseCCI, aucCI, aucABCI, tssABCI, baseCTSSCI, spearCI, baseRCI, spearABCI,file = "./Results/SimulationAggreationCIFig2.RData")
