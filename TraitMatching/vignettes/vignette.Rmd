...
```{r}
tm_effect = get_Interaction_Strengths(community$data[,-c(1,2)], model = results$Result$RF$result$models[[1]], any = FALSE, target = "target", grid_size = 5L, any_n_times = 1L, parallel = TRUE)
```
