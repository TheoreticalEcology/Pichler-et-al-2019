#' @export
# borrowed and adjusted from https://github.com/mlr-org
makeRLearner.regr.glm_self = function() {
  makeRLearnerRegr(
    cl = "regr.glm_self",
    package = "stats",
...
#' @export
trainLearner.regr.glm_self = function(.learner, .task, .subset, .weights = NULL, epsilon, maxit, trace, family,
                                 gaussian.link = "identity", poisson.link = "log", Gamma.link = "inverse", inverse.gaussian.link = "1/mu2",secondOrderInteractions=TRUE, ...) {
...
#' @export
predictLearner.regr.glm_self = function(.learner, .model, .newdata, ...) {
